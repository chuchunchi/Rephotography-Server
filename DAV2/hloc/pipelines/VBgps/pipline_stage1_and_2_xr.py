...
while(True):
    ...
    for sock in readsocks:
        if sock is ssock:
            ...
            # =========================xr=============================== recive client message
            frame_finish = recv_info(sock, 1)
            ...
            if frame_idx is not None:
                ...
                if Stage == '1' or Stage == '3':
                    ...
                    # string_data_length = len(string_data)
                    # print('string_data_length: ', string_data_length)
                    # string_data_length_bytes = string_data_length.to_bytes(4, 'big')
                    # sock.send(string_data_length_bytes)
                    ...
                    logs[c]["t_save_img"].append(t_00 - t_0)
        ...
        # =================================xr===================================
                    target_image = key_frame_list[step]
                    print(f"compare with key frame: {step}")
        ...
        # =================================xr===================================
                    ...
                    Points_match, drone_commend = flow_to_drone(current_realtime_frame, target_image, flow, Stage_2_results_path, stage2_count)
                    stage2_count += 1
                    #---------visualize flow ------------------------------------------
