from utils.core.utils.utils import InputPadder, coords_grid
# from hloc.utils.core.utils.utils import InputPadder, coords_grid
import torch
import cv2
import numpy as np
...
class Flow_estimator():
    def __init__(self, args):
        ...
        self.network.load_state_dict(torch.load(args.model, map_location=device), False)
        # print(self.network.state_dict().keys())
